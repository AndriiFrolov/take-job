...
public class IoUtils {
    ...
    public static Settings readSettingsFromFile() throws IOException {
        ObjectMapper mapper = new ObjectMapper();
        InputStream is = Settings.class.getResourceAsStream("/settings.json");
        return mapper.readValue(is, Settings.class);
    }
